document.addEventListener("DOMContentLoaded", () => {
    ...
    function formatAllKnowledge(database, subjectName) {
        ...
        database.forEach((item, index) => {
            ...
            const title = makeTopicTitle(item.keywords[0]);
    ...
    function getTopicList(database, subjectName) {
        ...
        database.forEach(item => {
            ...
            const topic = makeTopicTitle(item.keywords[0]);
    ...
    function isAllInformationRequest(text) {
        ...
        return allWords.some(phrase => text.includes(phrase));
    ...
    function simpleCalculator(question) {
        ...
        const hasCalculationWord =
            calculationWords.some(word => text.includes(word));
    ...
    function generalAnswer(question) {
        ...
        /* Good / fine response after greeting */
        ...
        if (
            ...
            return `Good ${text.replace("good ", "")}. What would you like to learn today?`;
...
You can ask me questions about any of these subjects.`;
    ...
    function generateAnswer(question) {
        ...
        /*
           ALL INFORMATION REQUEST
           This MUST happen before normal knowledge search.
        */
...
Tell me which subject you want to see the available questions for.`;
        ...
        const calculation = simpleCalculator(question);
...
Can you please repeat your question in an understandable way?`;
        ...
        const match = searchKnowledge(question, database);
        ...
        /*
           Do NOT say:
           "I understand that this is an economics question..."
        */
...
Can you please repeat your question in an understandable way?`;
    ...
    resetSettingsButton.addEventListener("click", () => {
        ...
        localStorage.removeItem("mastercommerce-theme");
        localStorage.removeItem("mastercommerce-font");
        localStorage.removeItem("mastercommerce-background");
        localStorage.removeItem("mastercommerce-motion");
