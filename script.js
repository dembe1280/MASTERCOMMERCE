document.addEventListener("DOMContentLoaded", () => {
    ...
    function isQuestion(text) {
        ...
        return questionStarters.some(start =>
    ...
    async function searchWikipedia(query) {
        ...
        try {
            ...
            /*
               ...
               before sending the search.
            */

            const searchQuery =
                cleanQuery
                    .replace(
                        /^(what|what is|what are|who is|who are|define|explain|tell me about|give me information about)\s+/i,
                        ""
                    )
                    .trim();
...
I can also search Wikipedia when the information is not available in my built-in knowledge.`;
...
I will use this information when answering future questions.`;
        ...
        if (!subject) {
            ...
            return `I'm not able to find that in my current knowledge or on Wikipedia.
...
Can you please repeat your question in an understandable way?`;
        ...
        return `I'm not able to find that exact topic in my current knowledge or on Wikipedia.
...
Can you please repeat your question in an understandable way?`;
    ...
    async function sendQuestion() {
        ...
        try {
            ...
            createMessage(
                "Something went wrong while searching for an answer. Please try again.",
                "assistant"
            );
